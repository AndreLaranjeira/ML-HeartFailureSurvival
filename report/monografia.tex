...
%\onehalfspacing
\title{Previsão de sobrevivência à insuficiência cardíaca com aprendizado de máquina em um website}
...
\siglapublicacao{IE.TG} % Instituto de ciências exatas - Trabalho de graduação.

\titulolinhai{Previsão de sobrevivência à}
\titulolinhaii{insuficiência cardíaca com}
\titulolinhaiii{aprendizado de máquina}
\titulolinhaiv{em um website}
...
\begin{document}
  ...
  \include{sections/abstract}
	...
	\include{sections/chapters/01_introducao}
	\include{sections/chapters/02_apresentacao_teorica}
	\include{sections/chapters/03_procedimento_adotado}
	\include{sections/chapters/04_resultados}
	\include{sections/chapters/05_conclusao}
