...
\begin{table}[ht!]
  ...
  \footnotesize {
    ...
    \hline
    \textit{DEATH\_EVENT} \newline (evento de morte) & Booleano (0 ou 1) & Se o paciente veio a óbito durante o período de acompanhamento médico (1) ou não (0). O período de acompanhamento médico tem duração média de 130 dias. \\
    \hline
    \end{tabular}
  }
